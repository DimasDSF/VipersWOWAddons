...
function Options:ToggleDropdown(anchor)
	local info = {
		...
		{
			text = L.DeleteNotify,
		    tooltipTitle = L.DeleteNotify,
		    tooltipText = L.DeleteNotifyDesc,
		    func = function() Scrap_DelNotify = not Scrap_DelNotify or nil end,
		    checked = function() return Scrap_DelNotify end
		},
    	{
